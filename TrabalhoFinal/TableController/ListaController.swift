...
class ListaController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        item = ItemListaLoja(titulo: "Casas Bahia", image: logo, image1: videogame, image2: pc)
        itens.append(item)
        
        item = ItemListaLoja(titulo: "Juninho Systems", image: logo, image1: videogame, image2: pc)
        itens.append(item)
    }
